...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-map-map-module"], {
  ...
  /***/
  function node_modulesAngular2BaiduMap__ivy_ngcc__Fesm2015Angular2BaiduMapJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BaiduMapModule", function () {
      return BaiduMapModule;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "ControlAnchor", function () {
      return ControlAnchor;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "LengthUnit", function () {
      return LengthUnit;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "MapTypeControlType", function () {
      return MapTypeControlType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "MapTypeEnum", function () {
      return MapTypeEnum;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NavigationControlType", function () {
      return NavigationControlType;
    });
    /* harmony export (binding) */
    ...
    var ScriptLoaderConfig = function ScriptLoaderConfig() {
      _classCallCheck(this, ScriptLoaderConfig);
    ...
    var ScriptLoader = /*#__PURE__*/function () {
      ...
      _createClass(ScriptLoader, [{
        ...
        value: function load(url) {
          ...
          var scriptUrls = isString(url) ? [url] : url['scripts'] // tslint:enable: no-string-literal
    ...
    ScriptLoader.ɵfac = function ScriptLoader_Factory(t) {
      return new (t || ScriptLoader)();
    };

    ScriptLoader.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ScriptLoader,
      factory: ScriptLoader.ɵfac
    });
    /** @nocollapse */

    ScriptLoader.ctorParameters = function () {
      return [];
    };
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScriptLoader, [{
    ...
    function switchDisplay(selector, state) {
      Array.prototype.slice.call(document.querySelectorAll(selector)).forEach(
      /**
      * @param {?} node
      * @return {?}
      */
    ...
    var MapService = /*#__PURE__*/function () {
      ...
      _createClass(MapService, [{
        ...
        value: function createMap(el, mapOptions) {
          ...
          /** @type {?} */
          var URL = "https://api.map.baidu.com/api?v=3.0&ak=".concat(this.config.ak, "&callback=baidumapinit");
          return new Promise(
          /**
          * @param {?} resolve
          * @return {?}
          ...
          function (resolve) {
            ...
            */
            function () {
              ...
              _this2.setOptions(mapOptions);

              _this2.mapResolver(map);
        ...
        value: function setOptions(opts) {
          var disableDragging = opts.disableDragging,
              enableScrollWheelZoom = opts.enableScrollWheelZoom,
              disableDoubleClickZoom = opts.disableDoubleClickZoom,
              enableKeyboard = opts.enableKeyboard,
              enableInertialDragging = opts.enableInertialDragging,
              enableAutoResize = opts.enableAutoResize,
              enableContinuousZoom = opts.enableContinuousZoom,
              disablePinchToZoom = opts.disablePinchToZoom;
          ...
          if (!isNull(opts.cursor)) {
            ...
            */
            function (map) {
              return map.setDefaultCursor(opts.cursor);
            });
          }
          ...
          if (!isNull(opts.draggingCursor)) {
            ...
            */
            function (map) {
              return map.setDraggingCursor(opts.draggingCursor);
            });
          }
          ...
          if (!isNull(opts.currentCity)) {
            ...
            */
            function (map) {
              return map.setCurrentCity(opts.currentCity);
            });
          }
        ...
        key: "addTileLayer",
        value: function addTileLayer(cb) {
          return this.map.then(
          /**
          * @param {?} map
          * @return {?}
        ...
        key: "removeTileLayer",
        value: function removeTileLayer(tilelayer) {
          return this.map.then(
          /**
          * @param {?} map
          * @return {?}
    ...
    MapService.ɵfac = function MapService_Factory(t) {
      return new (t || MapService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ScriptLoaderConfig), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ScriptLoader));
    };
    ...
    var ControlComponent = /*#__PURE__*/function () {
      ...
      _createClass(ControlComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            _this3.control = _this3.createControl(_this3.type, _this3.options);
            return _this3.control;
          }).then(
          /**
          * @param {?} __0
          * @return {?}
        ...
        key: "createControl",
        value: function createControl(type, options) {
          if (type === 'navigation') {
          ...
          throw new Error("Unsupported type:".concat(type, " of control"));
        }
      }]);
    ...
    ControlComponent.ɵfac = function ControlComponent_Factory(t) {
      return new (t || ControlComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    ControlComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    var MapComponent = /*#__PURE__*/function () {
      ...
      _createClass(MapComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this.service.createMap(this.mapInstance.nativeElement, this.options).then(
          /**
          * @param {?} map
          * @return {?}
          */
          function (map) {
            _this4.loaded.emit(map);
        ...
        key: "addListener",
        value: function addListener(map) {
          var _this5 = this;
    ...
    MapComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([MapService]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]],
      ngContentSelectors: _c1,
      decls: 7,
      vars: 1,
      consts: [[1, "baidu-map-instance"], ["mapinstance", ""], [1, "baidu-map-offline"], [1, "tranclude-content"]],
    ...
    var MarkerComponent = /*#__PURE__*/function () {
      ...
      _createClass(MarkerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.service.addOverlay(
          /**
          * @return {?}
          */
          function () {
            return _this6.marker = new window.BMap.Marker(toPoint(_this6.point), toMarkerOptions(_this6.options));
          }).then(
          /**
          * @param {?} __0
          * @return {?}
          */
          function (_ref2) {
            ...
            _this6.loaded.emit(_this6.marker);

            _this6.addListener(_this6.marker, map);
          }).then(
          /**
          * @return {?}
          */
          function () {
            ...
            _this6.marker.setPosition(new window.BMap.Point(_this6.point.lng, _this6.point.lat));
          });
        }
        /**
         * @param {?} changes
        ...
        key: "addListener",
        value: function addListener(marker, map) {
          var _this7 = this;
    ...
    MarkerComponent.ɵfac = function MarkerComponent_Factory(t) {
      return new (t || MarkerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    MarkerComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    var PolylineComponent = /*#__PURE__*/function () {
      ...
      _createClass(PolylineComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            return _this8.polyline = new window.BMap.Polyline(toPoints(_this8.points), _this8.options);
          }).then(
          /**
          * @param {?} __0
          * @return {?}
          */
          function (_ref3) {
            ...
            _this8.loaded.emit(_this8.polyline);

            _this8.addListener(_this8.polyline, map);
          });
        }
        /**
         * @param {?} changes
        ...
        key: "addListener",
        value: function addListener(polyline, map) {
          var _this9 = this;
    ...
    PolylineComponent.ɵfac = function PolylineComponent_Factory(t) {
      return new (t || PolylineComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    PolylineComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    var CircleComponent = /*#__PURE__*/function () {
      ...
      _createClass(CircleComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            return _this10.circle = new window.BMap.Circle(toPoint(_this10.center), _this10.radius, _this10.options);
          }).then(
          /**
          * @return {?}
          */
          function () {
            _this10.loaded.emit(_this10.circle);
          });
        }
        /**
         * @param {?} changes
    ...
    CircleComponent.ɵfac = function CircleComponent_Factory(t) {
      return new (t || CircleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    CircleComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    var PolygonComponent = /*#__PURE__*/function () {
      ...
      _createClass(PolygonComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            return _this11.polygon = new window.BMap.Polygon(toPoints(_this11.points), _this11.options);
          }).then(
          /**
          * @return {?}
          */
          function () {
            _this11.loaded.emit(_this11.polygon);
          });
        }
        /**
         * @param {?} changes
    ...
    PolygonComponent.ɵfac = function PolygonComponent_Factory(t) {
      return new (t || PolygonComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    PolygonComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    var HeatmapComponent = /*#__PURE__*/function () {
      ...
      _createClass(HeatmapComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            return _this12.scriptLoader.load(LIB_URL, false,
            /**
            * @return {?}
            */
            function () {
              _this12.service.addOverlay(
              /**
              * @return {?}
              */
              function () {
                return _this12.heatmap = new window.BMapLib.HeatmapOverlay(_this12.options);
              }).then(
              /**
              * @return {?}
              */
              function () {
                _this12.loaded.emit(_this12.heatmap);

                if (_this12.dataset) {
                  _this12.heatmap.setDataSet(_this12.dataset);
                }
              });
            });
          });
    ...
    HeatmapComponent.ɵfac = function HeatmapComponent_Factory(t) {
      return new (t || HeatmapComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ScriptLoader));
    };

    HeatmapComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeatmapComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
          selector: 'heatmap'
        }]
    ...
    var TileLayerComponent = /*#__PURE__*/function () {
      /**
       * @param {?} service
       */
      function TileLayerComponent(service) {
        _classCallCheck(this, TileLayerComponent);
      ...
      _createClass(TileLayerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this13 = this;
          ...
          this.service.addTileLayer(
          /**
          * @return {?}
          */
          function () {
            _this13.tilelayer = new window.BMap.TileLayer(_this13.options);

            if (_this13.getTilesUrl) {
              _this13.tilelayer.getTilesUrl =
              /**
              * @param {?} tileCoord
              * @param {?} zoom
              * @return {?}
            ...
            return _this13.tilelayer;
          }).then(
          /**
          * @return {?}
          */
          function () {
            _this13.loaded.emit(_this13.tilelayer);
          });
        }
        /**
         * @return {?}
    ...
    TileLayerComponent.ɵfac = function TileLayerComponent_Factory(t) {
      return new (t || TileLayerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    TileLayerComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TileLayerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
          selector: 'tilelayer'
        }]
    ...
    var TrafficLayerComponent = /*#__PURE__*/function () {
      /**
       * @param {?} service
       */
      function TrafficLayerComponent(service) {
        _classCallCheck(this, TrafficLayerComponent);
      ...
      _createClass(TrafficLayerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this14 = this;
          ...
          */
          function () {
            _this14.trafficlayer = new window.BMap.TrafficLayer(_this14.options);
            return _this14.trafficlayer;
          }).then(
          /**
          * @return {?}
          */
          function () {
            _this14.loaded.emit(_this14.trafficlayer);
          });
        }
        /**
         * @return {?}
    ...
    TrafficLayerComponent.ɵfac = function TrafficLayerComponent_Factory(t) {
      return new (t || TrafficLayerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    TrafficLayerComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: TrafficLayerComponent,
      selectors: [["trafficlayer"]],
      inputs: {
        options: "options"
      },
      outputs: {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TrafficLayerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
    ...
    var CanvasLayerComponent = /*#__PURE__*/function () {
      /**
       * @param {?} service
       */
      function CanvasLayerComponent(service) {
        _classCallCheck(this, CanvasLayerComponent);
      ...
      _createClass(CanvasLayerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this15 = this;
          ...
          */
          function (map) {
            _this15.canvaslayer = new window.BMap.CanvasLayer(_this15.getOptions(_this15.options, map));
            return _this15.canvaslayer;
          }).then(
          /**
          * @return {?}
          */
          function () {
            _this15.loaded.emit(_this15.canvaslayer);
          });
        }
        /**
         * @return {?}
        ...
        key: "getOptions",
        value: function getOptions(options, map) {
          if (!options) {
            return;
          }
          /** @type {?} */
    ...
    CanvasLayerComponent.ɵfac = function CanvasLayerComponent_Factory(t) {
      return new (t || CanvasLayerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService));
    };

    CanvasLayerComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: CanvasLayerComponent,
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CanvasLayerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
    ...
    var LIB_URLS = {
      key: 'markerClusterer',
      scripts: ['https://api.map.baidu.com/library/MarkerClusterer/1.2/src/MarkerClusterer_min.js', 'https://api.map.baidu.com/library/TextIconOverlay/1.2/src/TextIconOverlay_min.js']
    };

    var MarkerClustererComponent = /*#__PURE__*/function () {
      /**
       * @param {?} service
       * @param {?} scriptLoader
       */
      function MarkerClustererComponent(service, scriptLoader) {
        _classCallCheck(this, MarkerClustererComponent);
      ...
      _createClass(MarkerClustererComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this16 = this;
          ...
          */
          function (map) {
            return _this16.scriptLoader.load(LIB_URLS, false,
            /**
            * @return {?}
            */
            function () {
              _this16.markerClusterer = new window.BMapLib.MarkerClusterer(map, toMarkerClustererOptions(_this16.options));

              _this16.loaded.emit(_this16.markerClusterer);
            });
          });
        }
        /**
    ...
    MarkerClustererComponent.ɵfac = function MarkerClustererComponent_Factory(t) {
      return new (t || MarkerClustererComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](MapService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ScriptLoader));
    };

    MarkerClustererComponent.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: MarkerClustererComponent,
      selectors: [["marker-clusterer"]],
      inputs: {
        options: "options"
      },
      outputs: {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MarkerClustererComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
    ...
    var BaiduMapModule = /*#__PURE__*/function () {
      function BaiduMapModule() {
        _classCallCheck(this, BaiduMapModule);
      }

      _createClass(BaiduMapModule, null, [{
        key: "forRoot",
    ...
    BaiduMapModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: BaiduMapModule
    });
    BaiduMapModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function BaiduMapModule_Factory(t) {
        return new (t || BaiduMapModule)();
      }
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](BaiduMapModule, {
        declarations: [MapComponent, MarkerComponent, ControlComponent, PolylineComponent, CircleComponent, PolygonComponent, HeatmapComponent, TileLayerComponent, TrafficLayerComponent, CanvasLayerComponent, MarkerClustererComponent],
        exports: [MapComponent, MarkerComponent, ControlComponent, PolylineComponent, CircleComponent, PolygonComponent, HeatmapComponent, TileLayerComponent, TrafficLayerComponent, CanvasLayerComponent, MarkerClustererComponent]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BaiduMapModule, [{
  ...
  function srcAppComponentsLayoutsLayoutsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _footbar_footbar_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./footbar/footbar.component */
    "./src/app/components/layouts/footbar/footbar.component.ts");
    /* harmony import */


    var _quick_bar_quick_bar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    LayoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 0,
      consts: [[1, "ms-body", "ms-aside-left-open", "ms-primary-theme", "ms-has-quickbar"], [1, "body-content"], [1, "ms-content-wrapper"]],
  ...
  function srcAppComponentsLayoutsLayoutsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/shared/Module/shared.module */
    "./src/app/shared/Module/shared.module.ts");
    /* harmony import */


    var _side_navbar_side_navbar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./side-navbar/side-navbar.component */
    "./src/app/components/layouts/side-navbar/side-navbar.component.ts");
    /* harmony import */


    var _top_navbar_top_navbar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./top-navbar/top-navbar.component */
    "./src/app/components/layouts/top-navbar/top-navbar.component.ts");
    /* harmony import */
    ...
    var _footbar_footbar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./footbar/footbar.component */
    "./src/app/components/layouts/footbar/footbar.component.ts");
    /* harmony import */


    var _layouts_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./layouts.component */
    "./src/app/components/layouts/layouts.component.ts");
    ...
    LayoutModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LayoutModule, {
        declarations: [_footbar_footbar_component__WEBPACK_IMPORTED_MODULE_5__["FootbarComponent"], _side_navbar_side_navbar_component__WEBPACK_IMPORTED_MODULE_2__["SideNavbarComponent"], _top_navbar_top_navbar_component__WEBPACK_IMPORTED_MODULE_3__["TopNavbarComponent"], _quick_bar_quick_bar_component__WEBPACK_IMPORTED_MODULE_4__["QuickBarComponent"], _layouts_component__WEBPACK_IMPORTED_MODULE_6__["LayoutComponent"]],
        imports: [src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"]],
        exports: [_footbar_footbar_component__WEBPACK_IMPORTED_MODULE_5__["FootbarComponent"], _side_navbar_side_navbar_component__WEBPACK_IMPORTED_MODULE_2__["SideNavbarComponent"], _top_navbar_top_navbar_component__WEBPACK_IMPORTED_MODULE_3__["TopNavbarComponent"], _quick_bar_quick_bar_component__WEBPACK_IMPORTED_MODULE_4__["QuickBarComponent"], _layouts_component__WEBPACK_IMPORTED_MODULE_6__["LayoutComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    SideNavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function SideNavbarComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](12, 8, "Monitor"));
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](18, 10, "Routing"));
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](24, 12, "Replay"));
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](30, 14, "Reports"));
        }
      },
  ...
  function srcAppComponentsLayoutsTopNavbarTopNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TopNavbarComponent_div_78_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TopNavbarComponent_div_85_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 50);
    ...
    function TopNavbarComponent_div_92_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 50);
    ...
    var TopNavbarComponent = /*#__PURE__*/function () {
      ...
      _createClass(TopNavbarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.avatar = this.VDMSAVATARURL + this.user.avatar;
        ...
        value: function checkLogin() {
          ...
          var checkIfLogin = function checkIfLogin() {
            if (_this17.userService.isLoggedIn() == false) _this17.router.navigateByUrl(_this17.userService.loginURL);
          };
        ...
        value: function refresh() {
          var phone = '';
          if (this.role == 'admin' || this.role == 'user') phone = this.user.phone_number;else if (this.role == 'user') phone = this.user.contact_number;
    ...
    TopNavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      template: function TopNavbarComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TopNavbarComponent_Template_a_click_19_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("error", function TopNavbarComponent_Template_img_error_21_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TopNavbarComponent_Template_a_click_25_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("error", function TopNavbarComponent_Template_img_error_27_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("error", function TopNavbarComponent_Template_img_error_33_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TopNavbarComponent_Template_a_click_50_listener() {
            return ctx.logOut();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TopNavbarComponent_Template_button_click_94_listener() {
            return ctx.cancel();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function TopNavbarComponent_Template_button_click_97_listener() {
  ...
  /***/
  function srcAppComponentsMapMapRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_Service_userService_auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../../shared/Service/userService/auth/auth.guard */
    "./src/app/shared/Service/userService/auth/auth.guard.ts");
    /* harmony import */


    var _monitor_monitor_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./monitor/monitor.component */
    "./src/app/components/map/monitor/monitor.component.ts");
    /* harmony import */


    var _report_report_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./report/report.component */
    "./src/app/components/map/report/report.component.ts");
    /* harmony import */


    var _routing_routing_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./routing/routing.component */
    "./src/app/components/map/routing/routing.component.ts");
    /* harmony import */


    var _replay_replay_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var MapRoutes = [{
      path: '',
      component: _layouts_layouts_component__WEBPACK_IMPORTED_MODULE_5__["LayoutComponent"],
      canActivate: [_shared_Service_userService_auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
      canActivateChild: [_shared_Service_userService_auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
      children: [{
        path: '',
        redirectTo: '/map/monitor',
        pathMatch: 'full'
      }, {
        path: 'monitor',
        component: _monitor_monitor_component__WEBPACK_IMPORTED_MODULE_1__["MonitorComponent"]
      }, {
        path: 'routing',
        component: _routing_routing_component__WEBPACK_IMPORTED_MODULE_3__["RoutingComponent"]
      }, {
        path: 'replay',
        component: _replay_replay_component__WEBPACK_IMPORTED_MODULE_4__["ReplayComponent"]
      }, {
        path: 'report',
        component: _report_report_component__WEBPACK_IMPORTED_MODULE_2__["ReportComponent"]
      }]
    }];
    /***/
  },
  ...
  /***/
  function srcAppComponentsMapMapModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var angular2_baidu_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! angular2-baidu-map */
    "./node_modules/angular2-baidu-map/__ivy_ngcc__/fesm2015/angular2-baidu-map.js");
    /* harmony import */


    var src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/shared/Module/shared.module */
    "./src/app/shared/Module/shared.module.ts");
    /* harmony import */
    ...
    var _map_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./map-routing.module */
    "./src/app/components/map/map-routing.module.ts");
    /* harmony import */


    var _layouts_layouts_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../layouts/layouts.module */
    "./src/app/components/layouts/layouts.module.ts");
    /* harmony import */


    var _monitor_monitor_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./monitor/monitor.component */
    "./src/app/components/map/monitor/monitor.component.ts");
    /* harmony import */
    ...
    var _routing_routing_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./routing/routing.component */
    "./src/app/components/map/routing/routing.component.ts");
    /* harmony import */


    var _replay_replay_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./replay/replay.component */
    "./src/app/components/map/replay/replay.component.ts");
    ...
    MapModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _layouts_layouts_module__WEBPACK_IMPORTED_MODULE_5__["LayoutModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_map_routing_module__WEBPACK_IMPORTED_MODULE_4__["MapRoutes"]), angular2_baidu_map__WEBPACK_IMPORTED_MODULE_1__["BaiduMapModule"].forRoot({
        ak: 'qad8aIephigVOp8wW7ppY9SLaWQClGpv'
      })]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MapModule, {
        declarations: [_monitor_monitor_component__WEBPACK_IMPORTED_MODULE_6__["MonitorComponent"], _report_report_component__WEBPACK_IMPORTED_MODULE_7__["ReportComponent"], _routing_routing_component__WEBPACK_IMPORTED_MODULE_8__["RoutingComponent"], _replay_replay_component__WEBPACK_IMPORTED_MODULE_9__["ReplayComponent"]],
        imports: [src_app_shared_Module_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _layouts_layouts_module__WEBPACK_IMPORTED_MODULE_5__["LayoutModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], angular2_baidu_map__WEBPACK_IMPORTED_MODULE_1__["BaiduMapModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsMapMonitorMonitorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_Service_mapService_map_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/shared/Service/mapService/map.service */
    ...
    var _shared_Module_Datatable_DataTable__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../../shared/Module/Datatable/DataTable */
    "./src/app/shared/Module/Datatable/DataTable.ts");
    /* harmony import */


    var _shared_Module_Datatable_DefaultSorter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../shared/Module/Datatable/DefaultSorter */
    "./src/app/shared/Module/Datatable/DefaultSorter.ts");
    /* harmony import */


    var _shared_Module_Datatable_BootstrapPaginator__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../../shared/Module/Datatable/BootstrapPaginator */
    "./src/app/shared/Module/Datatable/BootstrapPaginator.ts");

    function MonitorComponent_ng_container_2_tr_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MonitorComponent_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MonitorComponent_ng_container_5_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      if (rf & 2) {
        var marker_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function MonitorComponent_ng_container_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function MonitorComponent_ng_container_21_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function MonitorComponent_ng_container_21_ng_container_1_Template_input_ngModelChange_3_listener($event) {
          ...
          return ctx_r14.selectionStatus[i_r12] = $event;
        });
      ...
      if (rf & 2) {
        ...
        var item_r11 = ctx_r17.$implicit;
        var i_r12 = ctx_r17.index;
    ...
    function MonitorComponent_ng_container_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    var MonitorComponent = /*#__PURE__*/function () {
      function MonitorComponent(userService, router, _formBuilder, toastr, mapService) {
        ...
        this._formBuilder = _formBuilder;
        this.toastr = toastr;
        this.mapService = mapService; //user

        this.user = ''; //Map_Settings
        ...
        this.sight = 400;
        this.mapzoom = 17; //selectionTable_Settings.

        this.foundedItem = [];
        this.selectionStatus = [];
        this.selectAll = true; //forMouseMoveIntroduce
      ...
      _createClass(MonitorComponent, [{
        ...
        value: function ngOnInit() {
          //user
          this.user = this.userService.getToken()['userInfo']; //map
        ...
        value: function getAll() {
          ...
          this.setTrackInfo(vehicleInfo); // this.mapService.getVehicleInfo(this.user).subscribe(
          //   res => {
        ...
        key: "setTrackInfo",
        value: function setTrackInfo(data) {
          var info = [{
            VehicleNumber: 'qwer',
            lat: 127,
            lng: 68
          ...
          this.setMap(info);
          this.infos = info; // this.mapService.getTrackInfoLast({ data: data }).subscribe(
          //   res => {
        ...
        key: "tableClose",
        value: function tableClose() {
          this.tableStatus = false;
        } //For selection table

      }, {
        key: "setCheckBox",
        value: function setCheckBox(data) {
          console.log(data);
        ...
        key: "checkBoxall",
        value: function checkBoxall() {
          this.checkSetAll(this.selectAll);
        }
      }, {
        key: "checkSetAll",
        value: function checkSetAll(status) {
          for (var i = 0; i < this.selectionStatus.length; i++) {
            this.selectionStatus[i] = status;
          }
        }
      }, {
        key: "checkKey",
        value: function checkKey(key, string) {
          if (!key) return true;
          if (string.indexOf(key) != -1) return true;else return false;
        } //For Maps
        ...
        key: "getCanvasLayer",
        value: function getCanvasLayer(opt) {
          var layer = {
            update: function update(map, canvas) {
              ...
              var pixel = map.pointToPixel(data); //set

              var radius = 30;
              var textsize = 15;
              var circleLineWidth = 5;
              var textLineWidth = 0.5;
              var name = opt.VehicleNumber;
              var text = name.substr(0, Math.floor(1.5 * radius / textsize)); //circle
              ...
              ctx.font = "" + textsize + "px Arial"; // ctx.strokeText(text, pixel.x, pixel.y);
        ...
        value: function setZoomAndCenter(opt) {
          var CZ = this.getCenter(opt);
          var center = {
            lat: CZ.lat,
            lng: CZ.lng,
            equals: Boolean
          ...
          var x = this.mapControl.pointToPixel(centerCritical).x - this.mapControl.pointToPixel(center).x;
          var y = this.mapControl.pointToPixel(centerCritical).y - this.mapControl.pointToPixel(center).y;
          var zoom = CZ.zoom;
          this.mapControl.panBy(x, y, {
            noAnimation: false
          });
        ...
        key: "getCenter",
        value: function getCenter(opt) {
          if (opt.length == 0) return;
          if (opt.length == 1) return {
            lat: opt[0].lat,
            lng: opt[0].lng,
            zoom: this.mapControl.getZoom()
          };
          var minLat, maxLat, minLng, maxLng, avgLat, avgLng;
          ...
          var width = Math.abs(this.mapControl.pointToPixel(min).x - this.mapControl.pointToPixel(max).x);
          var height = Math.abs(this.mapControl.pointToPixel(min).y - this.mapControl.pointToPixel(max).y);
          var critera = Math.max(width, height);
          var zoom = this.mapControl.getZoom() - Math.log2(critera / this.sight);
          return {
            lat: avgLat,
            lng: avgLng,
            zoom: zoom
        ...
        key: "setAnimation",
        value: function setAnimation(marker) {// marker.setAnimation(Animation.BMAP_ANIMATION_BOUNCE);
        }
      }, {
        key: "showWindow",
        value: function showWindow(_ref4) {
    ...
    MonitorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function MonitorComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("loaded", function MonitorComponent_Template_baidu_map_loaded_3_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function MonitorComponent_Template_input_change_12_listener() {
            return ctx.checkBoxall();
          })("ngModelChange", function MonitorComponent_Template_input_ngModelChange_12_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function MonitorComponent_Template_input_ngModelChange_15_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MonitorComponent_Template_button_click_23_listener() {
            return ctx.showInfo();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MonitorComponent, [{
        ...
        return [{
          ...
          type: src_app_shared_Service_mapService_map_service__WEBPACK_IMPORTED_MODULE_6__["UserMapService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppComponentsMapReplayReplayComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ReplayComponent", function () {
    ...
    function ReplayComponent_ng_container_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ReplayComponent_ng_container_15_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReplayComponent_ng_container_15_ng_container_1_Template_input_ngModelChange_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r9.vehicleNumber = $event;
        })("change", function ReplayComponent_ng_container_15_ng_container_1_Template_input_change_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r11.radioChange();
        });
    ...
    function ReplayComponent_ng_container_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ReplayComponent_div_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ReplayComponent_ng_container_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    var ReplayComponent = /*#__PURE__*/function () {
      function ReplayComponent(userService, router, _formBuilder, toastr, mapService) {
        _classCallCheck(this, ReplayComponent);
      ...
      _createClass(ReplayComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.user = this.userService.getToken()['userInfo']; //data

          this.date = this.getDateString(new Date()); //map
        ...
        value: function getAll() {
          ...
          this.foundedItem = vehicleInfo; // this.mapService.getVehicleInfo(this.user).subscribe(
          //   res => {
        ...
        value: function getTripInfo() {
          ...
          this.mapService.getTripInfo({
            ...
            _this19.trip = res['result'];

            _this19.setMap(_this19.trip);
          }, function (err) {
            console.log(err);
            _this19.trip = [];
          });
        ...
        key: "tripSet",
        value: function tripSet() {
          this.progress = 100 / (this.trip.length - 1) * this.curPoint;
          var t = new Date(this.trip[this.curPoint].track_time);
        ...
        key: "tripIntervals",
        value: function tripIntervals() {
          var _this20 = this;

          this.timeInterval = setInterval(function () {
            if (_this20.trip.length > _this20.curPoint + 1) {
              _this20.curPoint++;
              ...
              clearInterval(_this20.timeInterval);
            }
          }, 1000);
        }
      }, {
        ...
        value: function datechange() {
          if (this.mapstatus == false || this.ValidateDate(this.date)) return;
          this.getTripInfo();
        }
      }, {
        key: "getDateString",
        ...
        key: "ValidateDate",
        value: function ValidateDate(testdate) {
        ...
        key: "showWindow",
        value: function showWindow(_ref5) {
        ...
        key: "getCanvasLayer",
        value: function getCanvasLayer(cur, routes) {
          ...
          var layer = {
            update: function update(map, canvas) {
              ...
              ctx.clearRect(0, 0, ctx.canvas.width, ctx.canvas.height);
              if (routes.length == 0) return; //set

              var radiusStart = 10; //routes
              ...
              if (routes.length > 1) {
                ...
                for (var i = 1; i < routes.length; i++) {
                  var e = routes[i];
                  var ps = map.pointToPixel(new window.BMap.Point(s.y, s.x));
                  var pe = map.pointToPixel(new window.BMap.Point(e.y, e.x));
                  ctx.beginPath();
                  ctx.save();
                  ctx.lineWidth = 3;
              ...
              var dataCur = new window.BMap.Point(routes[cur].y, routes[cur].x);
              var pixelCur = map.pointToPixel(dataCur);
              ctx.beginPath();
              ctx.save();
              ctx.fillStyle = "black";
        ...
        key: "changePointToPixel",
        value: function changePointToPixel(lat, lng) {
          var center = {
            lat: lat,
            lng: lng,
            equals: Boolean
          };
          var x = this.mapControl.pointToPixel(center).x;
          var y = this.mapControl.pointToPixel(center).y;
          return {
            x: x,
            y: y
          };
    ...
    ReplayComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ReplayComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("loaded", function ReplayComponent_Template_baidu_map_loaded_2_listener($event) {
            return ctx.mapLoaded($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReplayComponent_Template_input_ngModelChange_9_listener($event) {
            return ctx.key = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReplayComponent_Template_input_ngModelChange_19_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReplayComponent_Template_button_click_28_listener() {
            return ctx.prevDate();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReplayComponent_Template_button_click_31_listener() {
            return ctx.prevFrame();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReplayComponent_Template_button_click_34_listener() {
            return ctx.start == false ? ctx.startTrip() : ctx.pauseTrip();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReplayComponent_Template_button_click_37_listener() {
            return ctx.nextFrame();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReplayComponent_Template_button_click_40_listener() {
            return ctx.nextDate();
          });
      ...
      directives: [angular2_baidu_map__WEBPACK_IMPORTED_MODULE_1__["ɵa"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], angular2_baidu_map__WEBPACK_IMPORTED_MODULE_1__["ɵm"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["RadioControlValueAccessor"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReplayComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
          selector: 'app-replay',
  ...
  /***/
  function srcAppComponentsMapReportReportComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ReportComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 18,
      vars: 0,
      consts: [[1, "row"], [1, "col-md-12"], ["aria-label", "breadcrumb"], [1, "breadcrumb", "pl-0"], [1, "breadcrumb-item"], ["routerLink", "/"], [1, "material-icons"], [1, "ms-panel"], [1, "ms-panel-header"], [1, "ms-panel-body"]],
  ...
  /***/
  function srcAppComponentsMapRoutingRoutingComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_Service_mapService_map_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/shared/Service/mapService/map.service */
    "./src/app/shared/Service/mapService/map.service.ts");
    /* harmony import */
    ...
    function RoutingComponent_option_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RoutingComponent_ng_container_14_div_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
    ...
    function RoutingComponent_ng_container_14_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RoutingComponent_ng_container_14_Template_button_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.plusWay();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RoutingComponent_ng_container_14_Template_input_ngModelChange_6_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

          var way_r7 = ctx.$implicit;
          return way_r7.query = $event;
        })("keyup", function RoutingComponent_ng_container_14_Template_input_keyup_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
          ...
          return ctx_r13.getLocationlist("way", i_r8);
        })("change", function RoutingComponent_ng_container_14_Template_input_change_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
          ...
          return ctx_r14.confirmLocation("way", i_r8);
        });
    ...
    function RoutingComponent_option_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 19);
    ...
    function RoutingComponent_option_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 19);
    ...
    var RoutingComponent = /*#__PURE__*/function () {
      function RoutingComponent(mapService) {
        _classCallCheck(this, RoutingComponent);

        this.mapService = mapService; //Map_Settings
      ...
      _createClass(RoutingComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //For searchResult

      }, {
        key: "plusWay",
        value: function plusWay() {
          this.queryWay.push({
            query: '',
            region: this.region
          });
        ...
        value: function caculateWay() {
          ...
          this.mapService.routeSearchTruck(query).subscribe(function (data) {
            console.log(data);
          }, function (err) {
            console.log(err);
          });
        ...
        key: "getLocationlist",
        value: function getLocationlist(where, id) {
          var _this21 = this;
          ...
          this.mapService.locationSearch(query).subscribe(function (res) {
            if (res["results"]) {
              var result = _this21.filterLocation(res["results"]);

              switch (where) {
                case 'from':
                  _this21.searchResultFrom = result;
                  break;

                case 'way':
                  _this21.searchResultWay = result;
                  break;

                case 'to':
                  _this21.searchResultTo = result;
                  break;
              }
            }
          }, function (err) {
        ...
        key: "confirmLocation",
        value: function confirmLocation(where, id) {
          var result = [];
        ...
        key: "filterLocation",
        value: function filterLocation(arr) {
          var loc = [];
        ...
        key: "getMathLocation",
        value: function getMathLocation(key, arr) {
          var loc = [];
        ...
        value: function checkStatus() {
          if (this.enableFrom && this.enableTo) {
            for (var i = 0; i < this.enableWay.length; i++) {
        ...
        value: function setZoomAndCenter(opt) {
          ...
          var x = this.mapControl.pointToPixel(center).x / this.optionsMap.centerAndZoom.zoom;
          var y = this.mapControl.pointToPixel(center).y / this.optionsMap.centerAndZoom.zoom;
        }
      }]);
    ...
    RoutingComponent.ɵfac = function RoutingComponent_Factory(t) {
      return new (t || RoutingComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_Service_mapService_map_service__WEBPACK_IMPORTED_MODULE_2__["UserMapService"]));
    };

    RoutingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RoutingComponent,
      selectors: [["app-routing"]],
      decls: 26,
      vars: 11,
      consts: [[1, "row"], [1, "mapDiv"], [3, "options", "loaded"], [1, "leftsideDiv"], [1, "ms-panel-body"], [1, "div1"], ["type", "button", 1, "ms-btn-icon", "btn-pill", "btn-primary", 3, "disabled", "click"], [1, "fa", "fa-plus"], [1, "div2"], ["list", "id-From", "placeholder", "From where?", 1, "form-control", 3, "ngModel", "ngModelChange", "keyup", "change"], ["class", "invalid-feedback", "style", "display: block;", 4, "ngIf"], ["id", "id-From"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], ["id", "id-way"], [1, "fa", "fa-search"], ["list", "id-To", "placeholder", "Target place?", 1, "form-control", 3, "ngModel", "ngModelChange", "keyup", "change"], ["id", "id-To"], [1, "invalid-feedback", 2, "display", "block"], [3, "value"], [1, "fa", "fa-minus"], ["list", "id-way", "placeholder", "middle ways?", 1, "form-control", 3, "ngModel", "ngModelChange", "keyup", "change"]],
      template: function RoutingComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("loaded", function RoutingComponent_Template_baidu_map_loaded_2_listener($event) {
            return ctx.mapLoaded($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RoutingComponent_Template_button_click_7_listener() {
            return ctx.plusWay();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RoutingComponent_Template_input_ngModelChange_10_listener($event) {
            return ctx.queryFrom.query = $event;
          })("keyup", function RoutingComponent_Template_input_keyup_10_listener() {
            return ctx.getLocationlist("from", 0);
          })("change", function RoutingComponent_Template_input_change_10_listener() {
            return ctx.confirmLocation("from", 0);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RoutingComponent_Template_button_click_19_listener() {
            return ctx.caculateWay();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RoutingComponent_Template_input_ngModelChange_22_listener($event) {
            return ctx.queryTo.query = $event;
          })("keyup", function RoutingComponent_Template_input_keyup_22_listener() {
            return ctx.getLocationlist("to", 0);
          })("change", function RoutingComponent_Template_input_change_22_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RoutingComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: src_app_shared_Service_mapService_map_service__WEBPACK_IMPORTED_MODULE_2__["UserMapService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppSharedServiceMapServiceMapServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserMapService", function () {
      return UserMapService;
    });
    /* harmony import */
    ...
    var UserMapService = /*#__PURE__*/function () {
      function UserMapService(http) {
        _classCallCheck(this, UserMapService);
      ...
      _createClass(UserMapService, [{
        key: "getVehicleInfo",
        value: function getVehicleInfo(data) {
          return this.http.post("/api/vehicle/get", data);
        }
      }, {
        key: "addVehicleInfo",
        value: function addVehicleInfo(data) {
          return this.http.post("/api/vehicle/add", data);
        }
      }, {
        key: "editVehicleInfo",
        value: function editVehicleInfo(data) {
          return this.http.post("/api/vehicle/edit", data);
        }
      }, {
        key: "delVehicleInfo",
        value: function delVehicleInfo(data) {
          return this.http.post("/api/vehicle/del", data);
        } //getTrackInfo

      }, {
        key: "getTrackInfoLast",
        value: function getTrackInfoLast(data) {
          return this.http.post("/api/track/getTrackInfoLast", data);
        } //getTrackInfo

      }, {
        key: "getReportInfoAll",
        value: function getReportInfoAll(data) {
          return this.http.post("/api/report/getAll", data);
        }
      }, {
        key: "getTripInfo",
        value: function getTripInfo(data) {
          return this.http.post("/api/track/getTripInfo", data);
        } //Location Search

      }, {
        key: "locationSearch",
        value: function locationSearch(data) {
          return this.http.get(this.baiduBaseUrlLocation + "query=" + data.query + "&" + "region=" + data.region + "&" + "ak=" + this.ak + "&output=json");
        } //Route Search

      }, {
        key: "routeSearchTruck",
        value: function routeSearchTruck(data) {
          var origin = "origin=" + data.origin.lat + "," + data.origin.lng;
          var destination = "&destination=" + data.destination.lat + "," + data.destination.lng;
          var waypoints = "";

          for (var i = 0; i < data.waypoints.length; i++) {
            if (i == 0) waypoints += "&waypoints=" + data.waypoints[i].lat + "," + data.waypoints[i].lng;else waypoints += "|" + data.waypoints[i].lat + "," + data.waypoints[i].lng;
          }

          var query = this.baiduBaseUrlRouteTruck + origin + waypoints + destination + "&ak=" + this.ak + "&output=json";
    ...
    UserMapService.ɵfac = function UserMapService_Factory(t) {
      return new (t || UserMapService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    UserMapService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: UserMapService,
      factory: UserMapService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserMapService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
